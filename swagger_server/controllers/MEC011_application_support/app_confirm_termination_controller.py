...
from swagger_server.controllers.internal.applications_information_manager import manage_application_termination_ready
...
def applications_confirm_termination_post(app_instance_id, body=None):  # noqa: E501
	...
	return manage_application_termination_ready(app_instance_id)
