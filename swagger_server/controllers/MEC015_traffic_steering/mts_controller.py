...
def mts_session_delete(session_id):  # noqa: E501
	...
	:param session_id: Represents a MTS session instance
	:type session_id: str
...
def mts_session_get(session_id):  # noqa: E501
...
def mts_session_put(body, session_id):  # noqa: E501
