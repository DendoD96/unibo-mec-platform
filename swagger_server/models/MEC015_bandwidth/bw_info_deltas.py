...
from swagger_server.models.MEC015_bandwidth.bw_info_deltas_session_filter import BwInfoDeltasSessionFilter  # noqa: F401,E501
...
class BwInfoDeltas(Model):
    ...
    """
    def __init__(self, allocation_direction: str=None, app_ins_id: str=None, fixed_allocation: str=None, fixed_bw_priority: str=None, request_type: str=None, session_filter: List[BwInfoDeltasSessionFilter]=None):  # noqa: E501
