...
from swagger_server.models.MEC015_bandwidth.bw_info_session_filter import \
	BwInfoSessionFilter  # noqa: F401 # pylint: disable=unused-import,E501
from swagger_server.models.MEC015_bandwidth.bw_info_time_stamp import \
	BwInfoTimeStamp  # noqa: F401 # pylint: disable=unused-import,E501
...
class BwInfo(Model):
	...
	def __init__(self, allocation_direction: str = None, app_ins_id: str = None, fixed_allocation: str = None,
	             fixed_bw_priority: str = None, request_type: int = None,
	             session_filter: List[BwInfoSessionFilter] = None, time_stamp: BwInfoTimeStamp = None):  # noqa: E501
