...
from swagger_server.models.MEC012_radio_network_information.rab_info_cell_user_info import \
	RabInfoCellUserInfo  # noqa: F401 # pylint: disable=unused-import,E501
...
class RabInfo(Model):
	...
	def __init__(self, app_instance_id: str = None, cell_user_info: List[RabInfoCellUserInfo] = None,
	             request_id: str = None, time_stamp: TimeStamp = None):  # noqa: E501
