...
from swagger_server.models.MEC012_radio_network_information.rab_rel_notification_erab_release_info import \
	RabRelNotificationErabReleaseInfo  # noqa: F401 # pylint: disable=unused-import,E501
...
class RabRelNotification(Model):
	...
	def __init__(self, associate_id: List[AssociateId] = None, ecgi: Ecgi = None,
	             erab_release_info: RabRelNotificationErabReleaseInfo = None, notification_type: str = None,
