...
from swagger_server.models.MEC012_radio_network_information.meas_rep_ue_notification_carrier_aggregation_meas_info import \
	MeasRepUeNotificationCarrierAggregationMeasInfo  # noqa: F401 # pylint: disable=unused-import,E501
from swagger_server.models.MEC012_radio_network_information.meas_rep_ue_notification_eutran_neighbour_cell_meas_info import \
	MeasRepUeNotificationEutranNeighbourCellMeasInfo  # noqa: F401 # pylint: disable=unused-import,E501
from swagger_server.models.MEC012_radio_network_information.meas_rep_ue_notification_new_radio_meas_info import \
	MeasRepUeNotificationNewRadioMeasInfo  # noqa: F401 # pylint: disable=unused-import,E501
from swagger_server.models.MEC012_radio_network_information.meas_rep_ue_notification_new_radio_meas_nei_info import \
	MeasRepUeNotificationNewRadioMeasNeiInfo  # noqa: F401 # pylint: disable=unused-import,E501
...
from swagger_server.models.MEC012_radio_network_information.trigger import \
	Trigger  # noqa: F401 # pylint: disable=unused-import,E501
...
class MeasRepUeNotification(Model):
	...
	def __init__(self, associate_id: List[AssociateId] = None,
	             carrier_aggregation_meas_info: List[MeasRepUeNotificationCarrierAggregationMeasInfo] = None,
	             ecgi: Ecgi = None,
	             eutran_neighbour_cell_meas_info: List[MeasRepUeNotificationEutranNeighbourCellMeasInfo] = None,
	             height_ue: int = None, new_radio_meas_info: List[MeasRepUeNotificationNewRadioMeasInfo] = None,
	             new_radio_meas_nei_info: List[MeasRepUeNotificationNewRadioMeasNeiInfo] = None,
	             notification_type: str = None, rsrp: int = None, rsrp_ex: int = None, rsrq: int = None,
	             rsrq_ex: int = None, sinr: int = None, time_stamp: TimeStamp = None,
	             trigger: Trigger = None):  # noqa: E501
	...
	def carrier_aggregation_meas_info(self, carrier_aggregation_meas_info: List[
	...
	def eutran_neighbour_cell_meas_info(self, eutran_neighbour_cell_meas_info: List[
