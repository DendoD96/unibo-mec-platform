...
from swagger_server.models.MEC012_radio_network_information.rab_est_subscription_filter_criteria_qci import \
	RabEstSubscriptionFilterCriteriaQci  # noqa: F401 # pylint: disable=unused-import,E501
...
class RabEstSubscription(Model):
	...
	def __init__(self, links: CaReconfSubscriptionLinks = None, callback_reference: str = None,
	             expiry_deadline: TimeStamp = None, filter_criteria_qci: RabEstSubscriptionFilterCriteriaQci = None,
