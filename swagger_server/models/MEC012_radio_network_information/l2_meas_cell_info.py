...
class L2MeasCellInfo(Model):
	...
	def __init__(self, dl_gbr_pdr_cell: int = None, dl_gbr_prb_usage_cell: int = None, dl_nongbr_pdr_cell: int = None,
	             dl_nongbr_prb_usage_cell: int = None, dl_total_prb_usage_cell: int = None, ecgi: Ecgi = None,
	             number_of_active_ue_dl_gbr_cell: int = None, number_of_active_ue_dl_nongbr_cell: int = None,
	             number_of_active_ue_ul_gbr_cell: int = None, number_of_active_ue_ul_nongbr_cell: int = None,
	             received_dedicated_preambles_cell: int = None,
	             received_randomly_selected_preambles_high_range_cell: int = None,
	             received_randomly_selected_preambles_low_range_cell: int = None, ul_gbr_pdr_cell: int = None,
	             ul_gbr_prb_usage_cell: int = None, ul_nongbr_pdr_cell: int = None,
	             ul_nongbr_prb_usage_cell: int = None, ul_total_prb_usage_cell: int = None):  # noqa: E501
