...
class MeasRepUeNotificationCarrierAggregationMeasInfo(Model):
	...
	def __init__(self, cell_id_nei: CellId = None, cell_id_srv: CellId = None, rsrp_nei: int = None,
	             rsrp_nei_ex: int = None, rsrp_srv: int = None, rsrp_srv_ex: int = None, rsrq_nei: int = None,
	             rsrq_nei_ex: int = None, rsrq_srv: int = None, rsrq_srv_ex: int = None, sinr_nei: int = None,
	             sinr_srv: int = None):  # noqa: E501
