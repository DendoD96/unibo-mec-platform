...
class CellChangeNotification(Model):
	...
	def __init__(self, associate_id: List[AssociateId] = None, ho_status: int = None, notification_type: str = None,
	             src_ecgi: Ecgi = None, temp_ue_id: CellChangeNotificationTempUeId = None, time_stamp: TimeStamp = None,
	             trg_ecgi: List[Ecgi] = None):  # noqa: E501
