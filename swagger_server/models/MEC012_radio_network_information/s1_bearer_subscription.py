...
from swagger_server.models.MEC012_radio_network_information.s1_bearer_subscription_s1_bearer_subscription_criteria import \
	S1BearerSubscriptionS1BearerSubscriptionCriteria  # noqa: F401 # pylint: disable=unused-import,E501
...
class S1BearerSubscription(Model):
	...
	def __init__(self, s1_bearer_subscription_criteria: S1BearerSubscriptionS1BearerSubscriptionCriteria = None,
	             links: CaReconfSubscriptionLinks = None, callback_reference: str = None, event_type: List[Enum] = None,
	             expiry_deadline: TimeStamp = None, subscription_type: str = None):  # noqa: E501
