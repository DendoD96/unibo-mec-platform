...
from swagger_server.models.MEC012_radio_network_information.s1_bearer_notification_s1_ue_info import \
	S1BearerNotificationS1UeInfo  # noqa: F401 # pylint: disable=unused-import,E501
...
class S1BearerNotification(Model):
	...
	def __init__(self, notification_type: str = None, s1_event: int = None,
	             s1_ue_info: S1BearerNotificationS1UeInfo = None, time_stamp: TimeStamp = None):  # noqa: E501
