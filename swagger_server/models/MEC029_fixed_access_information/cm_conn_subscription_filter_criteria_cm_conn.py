...
from swagger_server.models.MEC029_fixed_access_information.cm_conn_subscription_filter_criteria_cm_conn_cm_if import \
	CmConnSubscriptionFilterCriteriaCmConnCmIf  # noqa: F401 # pylint: disable=unused-import,E501
...
class CmConnSubscriptionFilterCriteriaCmConn(Model):
	...
	def __init__(self, cm_if: List[CmConnSubscriptionFilterCriteriaCmConnCmIf] = None,
	             customer_premises_info: CpInfo = None):  # noqa: E501
