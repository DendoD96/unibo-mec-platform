...
from swagger_server.models.MEC029_fixed_access_information.cable_line_info_cm_info_cm_status_cm_reg_state import \
	CableLineInfoCmInfoCmStatusCmRegState  # noqa: F401 # pylint: disable=unused-import,E501
...
class CableLineInfoCmInfoCmStatus(Model):
	...
	def __init__(self, cm_reg_state: CableLineInfoCmInfoCmStatusCmRegState = None, em_dls_oper_status: bool = None,
	             energy_mgt1x1_oper_status: bool = None, if_index: str = None, invalid_reg_rsps: int = None,
	             lost_syncs: int = None, resets: int = None):  # noqa: E501
