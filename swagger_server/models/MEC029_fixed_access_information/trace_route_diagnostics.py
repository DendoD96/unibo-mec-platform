...
from swagger_server.models.MEC029_fixed_access_information.trace_route_diagnostics_diagnostics_state import \
	TraceRouteDiagnosticsDiagnosticsState  # noqa: F401 # pylint: disable=unused-import,E501
...
class TraceRouteDiagnostics(Model):
	...
	def __init__(self, data_block_size: int = None, diagnostics_state: TraceRouteDiagnosticsDiagnosticsState = None,
	             host: str = None, max_hop_count: int = None, number_of_route_hops: int = None,
	             response_time: int = None, timeout: int = None):  # noqa: E501
