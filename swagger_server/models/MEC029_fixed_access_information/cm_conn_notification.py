...
from swagger_server.models.MEC029_fixed_access_information.cm_conn_notification_cm_if import CmConnNotificationCmIf  # noqa: F401,E501
...
class CmConnNotification(Model):
    ...
    """
    def __init__(self, cm_if: List[CmConnNotificationCmIf]=None, customer_premises_info: CpInfo=None, notification_type: str=None, time_stamp: TimeStamp=None):  # noqa: E501
