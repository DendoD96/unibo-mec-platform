...
from swagger_server.models.MEC029_fixed_access_information.pon_info_optical_network_info import \
	PonInfoOpticalNetworkInfo  # noqa: F401 # pylint: disable=unused-import,E501
...
class PonInfo(Model):
	...
	def __init__(self, customer_premises_info: List[CpInfo] = None,
	             optical_network_info: List[PonInfoOpticalNetworkInfo] = None, pon_sys_id: str = None,
