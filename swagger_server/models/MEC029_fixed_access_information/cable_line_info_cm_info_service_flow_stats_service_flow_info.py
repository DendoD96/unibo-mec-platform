...
class CableLineInfoCmInfoServiceFlowStatsServiceFlowInfo(Model):
	...
	def __init__(self, aqm_dropped_pkts: int = None, pkts: int = None, policed_delay_pkts: int = None,
	             policed_drop_pkts: int = None, service_flow_id: int = None, time_active: int = None,
	             time_created: TimeStamp = None):  # noqa: E501
