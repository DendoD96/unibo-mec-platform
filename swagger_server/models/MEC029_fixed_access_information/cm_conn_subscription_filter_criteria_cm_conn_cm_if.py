...
from swagger_server.models.MEC029_fixed_access_information.cm_conn_subscription_filter_criteria_cm_conn_cm_if_cm_reg_state import \
	CmConnSubscriptionFilterCriteriaCmConnCmIfCmRegState  # noqa: F401 # pylint: disable=unused-import,E501
...
class CmConnSubscriptionFilterCriteriaCmConnCmIf(Model):
	...
	def __init__(self, cm_id: str = None,
	             cm_reg_state: List[CmConnSubscriptionFilterCriteriaCmConnCmIfCmRegState] = None,
	             if_index: List[str] = None):  # noqa: E501
