...
class CableLineInfoCmInfoCmDpvStats(Model):
	...
	def __init__(self, avg_latency: int = None, if_index: str = None, last_meas_latency: int = None,
	             last_meas_time: TimeStamp = None, max_latency: int = None, min_latency: int = None,
	             num_meas: int = None):  # noqa: E501
