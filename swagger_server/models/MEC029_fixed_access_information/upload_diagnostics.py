...
from swagger_server.models.MEC029_fixed_access_information.upload_diagnostics_diagnostics_state import \
	UploadDiagnosticsDiagnosticsState  # noqa: F401 # pylint: disable=unused-import,E501
...
class UploadDiagnostics(Model):
	...
	def __init__(self, b_om_time: TimeStamp = None, diagnostics_state: UploadDiagnosticsDiagnosticsState = None,
	             e_om_time: TimeStamp = None, r_om_time: TimeStamp = None, t_cp_open_reponse_time: TimeStamp = None,
	             t_cp_open_request_time: TimeStamp = None, test_bytes_sent: int = None, test_file_length: int = None,
	             upload_uri: str = None):  # noqa: E501
