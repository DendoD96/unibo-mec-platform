...
from swagger_server.models.MEC029_fixed_access_information.onu_alarm_notification_alarm import \
	OnuAlarmNotificationAlarm  # noqa: F401 # pylint: disable=unused-import,E501
...
class OnuAlarmNotification(Model):
	...
	def __init__(self, alarm: OnuAlarmNotificationAlarm = None, customer_premises_info: List[CpInfo] = None,
	             notification_type: str = None, onu_id: str = None, time_stamp: TimeStamp = None):  # noqa: E501
