...
from swagger_server.models.MEC029_fixed_access_information.fa_info_connectivity_info import FaInfoConnectivityInfo  # noqa: F401,E501
...
class FaInfo(Model):
    ...
    """
    def __init__(self, connectivity_info: List[FaInfoConnectivityInfo]=None, customer_premises_info: List[CpInfo]=None, time_stamp: TimeStamp=None):  # noqa: E501
