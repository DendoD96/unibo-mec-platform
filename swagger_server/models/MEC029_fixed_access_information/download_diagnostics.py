...
from swagger_server.models.MEC029_fixed_access_information.download_diagnostics_diagnostics_state import DownloadDiagnosticsDiagnosticsState  # noqa: F401,E501
...
class DownloadDiagnostics(Model):
    ...
    """
    def __init__(self, b_om_time: TimeStamp=None, diagnostics_state: DownloadDiagnosticsDiagnosticsState=None, download_uri: str=None, e_om_time: TimeStamp=None, r_om_time: TimeStamp=None, t_cp_open_reponse_time: TimeStamp=None, t_cp_open_request_time: TimeStamp=None, test_bytes_received: int=None, total_bytes_received: int=None):  # noqa: E501
