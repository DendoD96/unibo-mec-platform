...
class ProblemDetails(Model):
	...
	def __init__(self, detail: str = None, instance: str = None, status: int = None, title: str = None,
	             type: str = None):  # noqa: E501 # pylint: disable=redefined-builtin
	...
	@type.setter
	def type(self, type: str):  # pylint: disable=redefined-builtin
