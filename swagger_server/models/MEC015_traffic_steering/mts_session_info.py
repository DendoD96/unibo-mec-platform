...
from swagger_server.models.MEC015_traffic_steering.mts_session_info_flow_filter import \
	MtsSessionInfoFlowFilter  # noqa: F401 # pylint: disable=unused-import,E501
from swagger_server.models.MEC015_traffic_steering.mts_session_info_qos_d import \
	MtsSessionInfoQosD  # noqa: F401 # pylint: disable=unused-import,E501
from swagger_server.models.MEC015_traffic_steering.mts_session_info_time_stamp import \
	MtsSessionInfoTimeStamp  # noqa: F401 # pylint: disable=unused-import,E501
...
class MtsSessionInfo(Model):
	...
	def __init__(self, app_ins_id: str = None, flow_filter: List[MtsSessionInfoFlowFilter] = None, mts_mode: int = None,
	             qos_d: MtsSessionInfoQosD = None, request_type: int = None, time_stamp: MtsSessionInfoTimeStamp = None,
	             traffic_direction: str = None):  # noqa: E501
		"""MtsSessionInfo - a model defined in Swagger
	...
	@property
	def flow_filter(self) -> List[MtsSessionInfoFlowFilter]:
	...
	@flow_filter.setter
	def flow_filter(self, flow_filter: List[MtsSessionInfoFlowFilter]):
	...
	@mts_mode.setter
	def mts_mode(self, mts_mode: int):
	...
	@property
	def qos_d(self) -> MtsSessionInfoQosD:
	...
	@qos_d.setter
	def qos_d(self, qos_d: MtsSessionInfoQosD):
	...
	@property
	def time_stamp(self) -> MtsSessionInfoTimeStamp:
	...
	@time_stamp.setter
	def time_stamp(self, time_stamp: MtsSessionInfoTimeStamp):
	...
	def traffic_direction(self, traffic_direction: str):
