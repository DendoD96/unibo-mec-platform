...
class MtsSessionInfoFlowFilter(Model):
    ...
    """
    def __init__(self, dscp: int=None, dst_ip: str=None, dst_port: List[int]=None, flowlabel: int=None, protocol: int=None, source_ip: str=None, source_port: List[int]=None):  # noqa: E501
