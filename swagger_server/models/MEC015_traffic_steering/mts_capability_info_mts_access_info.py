...
class MtsCapabilityInfoMtsAccessInfo(Model):
    ...
    """
    def __init__(self, access_id: int=None, access_type: int=None, metered: int=None):  # noqa: E501
        """MtsCapabilityInfoMtsAccessInfo - a model defined in Swagger
    ...
    @access_id.setter
    def access_id(self, access_id: int):
    ...
    @access_type.setter
    def access_type(self, access_type: int):
