...
class BssCapabilities(Model):
    ...
    """
    def __init__(self, apsd: bool=None, delayed_back: bool=None, immediate_back: bool=None, qos: bool=None, radio_measurements: bool=None, spectrum_management: bool=None):  # noqa: E501
