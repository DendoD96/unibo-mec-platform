...
from swagger_server.models.MEC028_wlan_access_information.measurement_config_link_list_measurement_config import \
	MeasurementConfigLinkListMeasurementConfig  # noqa: F401 # pylint: disable=unused-import,E501
...
class MeasurementConfigLinkList(Model):
	...
	def __init__(self, links: MeasurementConfigLinks = None,
	             measurement_config: List[MeasurementConfigLinkListMeasurementConfig] = None):  # noqa: E501
