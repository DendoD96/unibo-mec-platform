...
from swagger_server.models.MEC028_wlan_access_information.reported_beacon_frame_info import ReportedBeaconFrameInfo  # noqa: F401,E501
...
class BeaconReport(Model):
    ...
    """
    def __init__(self, antenna_id: int=None, bssid: str=None, channel: int=None, measurement_id: str=None, operating_class: int=None, parent_tsf: int=None, rcpi: int=None, reported_frame_info: ReportedBeaconFrameInfo=None, rsni: int=None, ssid: str=None, sta_id: StaIdentity=None):  # noqa: E501
