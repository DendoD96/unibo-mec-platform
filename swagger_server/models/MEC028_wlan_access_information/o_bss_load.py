...
class OBssLoad(Model):
	...
	def __init__(self, allocated_traffic_self_mean: int = None, allocated_traffic_self_std_dev: int = None,
	             allocated_traffic_share_mean: int = None, allocated_traffic_share_std_dev: int = None,
	             overlap: int = None):  # noqa: E501
