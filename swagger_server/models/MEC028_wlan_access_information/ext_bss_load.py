...
class ExtBssLoad(Model):
    ...
    """
    def __init__(self, mu_mimo_sta_count: int=None, obs_sec20_mhz_util: int=None, obs_sec40_mhz_util: int=None, obs_sec80_mhz_util: int=None, spat_stream_under_util: int=None):  # noqa: E501
