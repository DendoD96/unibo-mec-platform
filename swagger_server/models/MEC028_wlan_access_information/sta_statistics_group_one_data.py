...
class StaStatisticsGroupOneData(Model):
    ...
    """
    def __init__(self, ack_failure_count: int=None, frame_duplicate_count: int=None, multiple_retry_count: int=None, reporting_reason_sta_counters: ReportingReasonStaCounters=None, retry_count: int=None, rts_failure_count: int=None, rts_success_count: int=None):  # noqa: E501
