...
class ReportingReasonStaCounters(Model):
    ...
    """
    def __init__(self, ack_failure: bool=None, failed: bool=None, fcs_error: bool=None, frame_duplicate: bool=None, multiple_retry: bool=None, retry: bool=None, rts_failure: bool=None):  # noqa: E501
