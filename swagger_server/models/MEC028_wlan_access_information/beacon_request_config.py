...
from swagger_server.models.MEC028_wlan_access_information.beacon_reporting_config import \
	BeaconReportingConfig  # noqa: F401 # pylint: disable=unused-import,E501
...
class BeaconRequestConfig(Model):
	...
	def __init__(self, beacon_reporting_conf: BeaconReportingConfig = None, bssid: str = None, channel_id: int = None,
	             measurement_mode: int = None, operating_class: int = None, ssid: str = None):  # noqa: E501
