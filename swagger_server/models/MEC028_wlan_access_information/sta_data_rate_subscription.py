...
from swagger_server.models.MEC028_wlan_access_information.sta_data_rate_subscription_notification_event import \
	StaDataRateSubscriptionNotificationEvent  # noqa: F401 # pylint: disable=unused-import,E501
...
class StaDataRateSubscription(Model):
	...
	def __init__(self, links: AssocStaSubscriptionLinks = None, callback_reference: str = None,
	             expiry_deadline: TimeStamp = None, notification_event: StaDataRateSubscriptionNotificationEvent = None,
	             notification_period: int = None, request_test_notification: bool = None,
