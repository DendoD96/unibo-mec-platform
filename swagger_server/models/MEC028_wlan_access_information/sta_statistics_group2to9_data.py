...
from swagger_server.models.MEC028_wlan_access_information.reporting_reason_qo_s_counters import ReportingReasonQoSCounters  # noqa: F401,E501
...
class StaStatisticsGroup2to9Data(Model):
    ...
    """
    def __init__(self, qos_ack_failure_count: int=None, qos_discarded_frame_count: int=None, qos_failed_count: int=None, qos_frame_duplicate_count: int=None, qos_mpd_us_received_count: int=None, qos_multiple_retry_count: int=None, qos_rts_failure_count: int=None, qos_rts_success_count: int=None, qos_received_fragment_count: int=None, qos_retries_received_count: int=None, qos_retry_count: int=None, qos_transmitted_fragment_count: int=None, qos_transmitted_frame_count: int=None, reporting_reason_qo_s_counters: ReportingReasonQoSCounters=None):  # noqa: E501
