...
from swagger_server.models.MEC028_wlan_access_information.bssid_info import \
	BssidInfo  # noqa: F401 # pylint: disable=unused-import,E501
...
class NeighborReport(Model):
	...
	def __init__(self, bss_transition_candidate_preference: int = None, bssid: str = None, bssid_info: BssidInfo = None,
	             channel: int = None, measurement_id: str = None, operating_class: int = None, phy_type: int = None,
