...
class MeasurementReportSubscription(Model):
    ...
    """
    def __init__(self, links: AssocStaSubscriptionLinks=None, callback_reference: str=None, expiry_deadline: TimeStamp=None, measurement_id: str=None, measurement_info: MeasurementInfo=None, request_test_notification: bool=None, sta_id: List[StaIdentity]=None, subscription_type: str=None, websock_notif_config: WebsockNotifConfig=None):  # noqa: E501
