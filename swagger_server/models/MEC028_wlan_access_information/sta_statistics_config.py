...
from swagger_server.models.MEC028_wlan_access_information.sta_counter_trigger_condition import \
	STACounterTriggerCondition  # noqa: F401 # pylint: disable=unused-import,E501
...
class StaStatisticsConfig(Model):
	...
	def __init__(self, group_identity: int = None, measurement_count: int = None,
	             trigger_condition: STACounterTriggerCondition = None, trigger_timeout: int = None,
	             triggered_report: bool = None):  # noqa: E501
