...
from swagger_server.models.MEC028_wlan_access_information.expiry_notification_links import \
	ExpiryNotificationLinks  # noqa: F401 # pylint: disable=unused-import,E501
...
class ExpiryNotification(Model):
	...
	def __init__(self, links: ExpiryNotificationLinks = None, expiry_deadline: TimeStamp = None,
	             notification_type: str = None):  # noqa: E501
