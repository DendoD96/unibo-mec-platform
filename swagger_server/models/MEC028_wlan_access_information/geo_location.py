...
class GeoLocation(Model):
    ...
    """
    def __init__(self, altitude: int=None, altitude_type: int=None, altitude_uncertainty: int=None, datum: int=None, lat: int=None, lat_uncertainty: int=None, long: int=None, long_uncertainty: int=None):  # noqa: E501
