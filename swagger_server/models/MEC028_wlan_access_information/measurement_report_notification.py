...
class MeasurementReportNotification(Model):
    ...
    """
    def __init__(self, beacon_report: List[BeaconReport]=None, channel_load: List[ChannelLoad]=None, neighbor_report: List[NeighborReport]=None, notification_type: str=None, sta_statistics: List[StaStatistics]=None, time_stamp: TimeStamp=None):  # noqa: E501
