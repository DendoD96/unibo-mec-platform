...
class STACounterTriggerCondition(Model):
    ...
    """
    def __init__(self, ack_failure_count_threshold: int=None, failed_count_threshold: int=None, fcs_error_count_threshold: int=None, frame_duplicate_count_threshold: int=None, multiple_retry_count_threshold: int=None, retry_count_threshold: int=None, rts_failure_count_threshold: int=None):  # noqa: E501
