...
class HtCapabilities(Model):
	...
	def __init__(self, ampdu_parameters: int = None, asel_cap: int = None, ht_capability_info: int = None,
	             ht_extended_cap: int = None, supported_mcs_set: int = None,
	             tx_beam_form_cap: int = None):  # noqa: E501
