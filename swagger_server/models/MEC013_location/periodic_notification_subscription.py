...
class PeriodicNotificationSubscription(Model):
    ...
    """
    def __init__(self, address: List[str]=None, callback_reference: CallbackReference=None, client_correlator: str=None, duration: int=None, frequency: int=None, link: List[Link]=None, requested_accuracy: int=None, requester: str=None, resource_url: str=None):  # noqa: E501
