...
class ZoneStatusNotification(Model):
    ...
    """
    def __init__(self, access_point_id: str=None, callback_data: str=None, link: List[Link]=None, number_of_users_in_ap: int=None, number_of_users_in_zone: int=None, operation_status: OperationStatus=None, timestamp: TimeStamp=None, zone_id: str=None):  # noqa: E501
