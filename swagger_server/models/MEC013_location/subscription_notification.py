...
from swagger_server.models.MEC013_location.distance_criteria import DistanceCriteria  # noqa: F401,E501
...
from swagger_server.models.MEC013_location.terminal_location import TerminalLocation  # noqa: F401,E501
...
class SubscriptionNotification(Model):
    ...
    """
    def __init__(self, callback_data: str=None, distance_criteria: DistanceCriteria=None, entering_leaving_criteria: EnteringLeavingCriteria=None, is_final_notification: bool=None, link: List[Link]=None, terminal_location: List[TerminalLocation]=None):  # noqa: E501
