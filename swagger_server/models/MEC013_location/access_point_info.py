...
from swagger_server.models.MEC013_location.connection_type import \
	ConnectionType  # noqa: F401 # pylint: disable=unused-import,E501
...
class AccessPointInfo(Model):
	...
	def __init__(self, access_point_id: str = None, connection_type: ConnectionType = None, interest_realm: str = None,
	             location_info: LocationInfo = None, number_of_users: int = None,
	             operation_status: OperationStatus = None, resource_url: str = None,
	             timezone: str = None):  # noqa: E501
