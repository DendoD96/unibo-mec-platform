...
from swagger_server.models.MEC013_location.location_info_velocity import \
	LocationInfoVelocity  # noqa: F401 # pylint: disable=unused-import,E501
...
class LocationInfo(Model):
	...
	def __init__(self, accuracy: int = None, accuracy_altitude: int = None, accuracy_semi_minor: int = None,
	             altitude: float = None, confidence: int = None, included_angle: int = None, inner_radius: int = None,
	             latitude: List[float] = None, longitude: List[float] = None, offset_angle: int = None,
	             orientation_major_axis: int = None, shape: int = None, timestamp: TimeStamp = None,
	             uncertainty_radius: int = None, velocity: LocationInfoVelocity = None):  # noqa: E501
