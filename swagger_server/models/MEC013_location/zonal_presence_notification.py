...
class ZonalPresenceNotification(Model):
    ...
    """
    def __init__(self, address: str=None, callback_data: str=None, current_access_point_id: str=None, interest_realm: str=None, link: List[Link]=None, previous_access_point_id: str=None, timestamp: TimeStamp=None, user_event_type: UserEventType=None, zone_id: str=None):  # noqa: E501
