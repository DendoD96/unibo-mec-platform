...
class UserTrackingSubscription(Model):
	...
	def __init__(self, address: str = None, callback_reference: CallbackReference = None, client_correlator: str = None,
	             resource_url: str = None, user_event_criteria: List[UserEventType] = None):  # noqa: E501
