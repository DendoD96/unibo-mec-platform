...
class CircleNotificationSubscription(Model):
	...
	def __init__(self, address: List[str] = None, callback_reference: CallbackReference = None,
	             check_immediate: bool = None, client_correlator: str = None, count: int = None, duration: int = None,
	             entering_leaving_criteria: EnteringLeavingCriteria = None, frequency: int = None,
	             latitude: float = None, link: List[Link] = None, longitude: float = None, radius: float = None,
	             requester: str = None, resource_url: str = None, tracking_accuracy: float = None):  # noqa: E501
