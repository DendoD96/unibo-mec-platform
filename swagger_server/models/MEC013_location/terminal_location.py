...
from swagger_server.models.MEC013_location.retrieval_status import \
	RetrievalStatus  # noqa: F401 # pylint: disable=unused-import,E501
...
class TerminalLocation(Model):
	...
	def __init__(self, address: str = None, current_location: LocationInfo = None,
	             error_information: ServiceError = None,
	             location_retrieval_status: RetrievalStatus = None):  # noqa: E501
