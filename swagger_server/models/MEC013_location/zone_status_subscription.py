...
class ZoneStatusSubscription(Model):
    ...
    """
    def __init__(self, callback_reference: CallbackReference=None, client_correlator: str=None, number_of_users_ap_threshold: int=None, number_of_users_zone_threshold: int=None, operation_status: List[OperationStatus]=None, resource_url: str=None, zone_id: str=None):  # noqa: E501
