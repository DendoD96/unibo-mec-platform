...
class ZoneInfo(Model):
	...
	def __init__(self, number_of_access_points: int = None, number_of_unserviceable_access_points: int = None,
	             number_of_users: int = None, resource_url: str = None, zone_id: str = None):  # noqa: E501
	...
	def number_of_unserviceable_access_points(self, number_of_unserviceable_access_points: int):
		...
		if number_of_unserviceable_access_points is None:
			raise ValueError(
				"Invalid value for `number_of_unserviceable_access_points`, must not be `None`")  # noqa: E501
