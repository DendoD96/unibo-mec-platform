...
from swagger_server.models.MEC013_location.notification_format import NotificationFormat  # noqa: F401,E501
...
class CallbackReference(Model):
    ...
    """
    def __init__(self, callback_data: str=None, notification_format: NotificationFormat=None, notify_url: str=None):  # noqa: E501
