...
class UserInfo(Model):
    ...
    """
    def __init__(self, access_point_id: str=None, address: str=None, ancillary_info: str=None, context_location_info: str=None, location_info: LocationInfo=None, resource_url: str=None, timestamp: TimeStamp=None, zone_id: str=None):  # noqa: E501
