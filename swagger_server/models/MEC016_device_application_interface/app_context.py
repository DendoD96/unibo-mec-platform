...
from swagger_server.models.MEC016_device_application_interface.app_context_app_info import \
	AppContextAppInfo  # noqa: F401 # pylint: disable=unused-import,E501
...
class AppContext(Model):
	...
	def __init__(self, app_auto_instantiation: bool = None, app_info: AppContextAppInfo = None,
	             app_location_updates: bool = None, associate_dev_app_id: str = None, callback_reference: str = None,
	             context_id: str = None):  # noqa: E501
