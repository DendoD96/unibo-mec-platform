...
from swagger_server.models.MEC016_device_application_interface.app_context_app_info_user_app_instance_info import AppContextAppInfoUserAppInstanceInfo  # noqa: F401,E501
...
class AppContextAppInfo(Model):
    ...
    """
    def __init__(self, app_d_id: str=None, app_d_version: str=None, app_description: str=None, app_name: str=None, app_provider: str=None, app_soft_version: str=None, app_package_source: str=None, user_app_instance_info: List[AppContextAppInfoUserAppInstanceInfo]=None):  # noqa: E501
