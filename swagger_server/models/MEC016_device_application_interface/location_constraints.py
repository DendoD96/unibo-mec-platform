...
from swagger_server.models.MEC016_device_application_interface.location_constraints_civic_address_element import \
	LocationConstraintsCivicAddressElement  # noqa: F401 # pylint: disable=unused-import,E501
from swagger_server.models.MEC016_device_application_interface.polygon import \
	Polygon  # noqa: F401 # pylint: disable=unused-import,E501
...
class LocationConstraints(Model):
	...
	def __init__(self, area: Polygon = None, civic_address_element: List[LocationConstraintsCivicAddressElement] = None,
	             country_code: str = None):  # noqa: E501
