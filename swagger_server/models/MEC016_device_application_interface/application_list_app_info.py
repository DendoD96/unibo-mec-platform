...
from swagger_server.models.MEC016_device_application_interface.application_list_app_info_app_charcs import \
	ApplicationListAppInfoAppCharcs  # noqa: F401 # pylint: disable=unused-import,E501
...
class ApplicationListAppInfo(Model):
	...
	def __init__(self, app_charcs: ApplicationListAppInfoAppCharcs = None, app_d_id: str = None,
	             app_d_version: str = None, app_description: str = None, app_location: List[LocationConstraints] = None,
	             app_name: str = None, app_provider: str = None, app_soft_version: str = None):  # noqa: E501
