...
class ApplicationLocationAvailabilityNotification(Model):
    ...
    """
    def __init__(self, available_locations: List[ApplicationLocationAvailabilityAppInfoAvailableLocations]=None, context_id: str=None, notification_type: str=None):  # noqa: E501
