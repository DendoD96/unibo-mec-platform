...
from swagger_server.models.MEC011_service_management.service_availability_notification_change_type import ServiceAvailabilityNotificationChangeType  # noqa: F401,E501
...
class ServiceAvailabilityNotificationServiceReferences(Model):
    ...
    """
    def __init__(self, link: LinkType=None, ser_name: ServiceInfoSerName=None, ser_instance_id: ServiceInfoSerInstanceId=None, state: ServiceState=None, change_type: ServiceAvailabilityNotificationChangeType=None):  # noqa: E501
